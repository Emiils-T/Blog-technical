            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6 mr-4">
                <form class="w-64">
                    ...
                    <div class="relative">
                        ...
                        <button type="submit" class="text-white absolute end-1 top-1/2 transform -translate-y-1/2 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-1.5 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Search</button>
                    </div>
                </form>
            </div>
