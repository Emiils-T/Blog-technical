            ...
            <a href="posts/{{$posts[0]->id}}" class="block max-w-sm gap-3 mx-auto sm:max-w-full group hover:no-underline focus:no-underline lg:grid lg:grid-cols-12 dark:bg-gray-50">
                ...
                <div class="p-6 space-y-2 lg:col-span-5 bg-gray-50">
                    ...
                    <div class="relative mt-4 h-48 overflow-hidden">
                        <p>{{$posts[0]->body}}</p>
                        <div class="absolute bottom-0 left-0 h-full w-full bg-gradient-to-t from-gray-50 to-transparent rounded-lg"></div>
                    </div>
                </div>
            </a>
            <div class="grid justify-center grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                @for($i=1;$i<count($posts);$i++)
                    <a rel="noopener noreferrer" href="posts/{{$posts[$i]->id}}" class="max-w-sm mx-auto group hover:no-underline focus:no-underline dark:bg-gray-50">
                        ...
                        <div class="p-6 space-y-2 bg-gray-50">
                            ...
                            <span>{{$posts[$i]->author_name}} </span><span class="text-xs text-gray-300 dark:text-gray-600">•</span>
